...
function loadGrain2(levels){
    let result =0
    let wall = 0
    for(i=0; i < levels.length-1 ; i++ ){
        if(levels[i]<wall ){
                result += wall - levels[i]
        }  else {
            wall = levels[i]
        }
    }
...
console.log(loadGrain2([4, 1, 3]))
console.log(loadGrain2([2, 1, 5, 2, 7, 4, 10]))
console.log(loadGrain2([2, 0, 1, 5, 2, 7]))
console.log(loadGrain2([2, 4, 2]))
console.log(loadGrain2([7, 4]))
console.log(loadGrain2([]))
